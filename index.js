...
app.get('/qr', async (req, res) => {
  ...
  if (!latestQr) return res.send('<h2 style="font-family:sans-serif">⏳ جاري التحضير... حدّث الصفحة بعد 15 ثانية</h2>');
  ...
  res.send(`
    ...
    <body style="font-family:sans-serif;text-align:center;padding:40px;background:#0f0f0f;color:white">
      ...
      <p style="color:#aaa">واتساب ← النقاط الثلاث ← الأجهزة المرتبطة ← ربط جهاز</p>
      <img src="${url}" style="width:300px;height:300px;border-radius:12px" />
      <p style="color:#666;font-size:14px">بعد المسح حدّث الصفحة للتأكد</p>
